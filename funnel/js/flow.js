...
var CHECKOUT_URL_YEAR = 'https://rubyalex5.gumroad.com/l/annual?wanted=true';
                                  /* годовой план, $29.99/год с автопродлением.
                                     Это ОТДЕЛЬНЫЙ товар в Gumroad, а не вариант
                                     месячного, поэтому у него свой product_id, и
                                     воркер license-verify должен знать оба —
                                     иначе ключ годового подписчика не пройдёт
                                     проверку. См. GUMROAD_PRODUCT_ID там. */
